        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              href="mailto: ivictorcanas@gmail.com"
              title="Email"
              className="flex items-center justify-center w-10 h-10 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900"
            >
              <svg
            ...
            <a
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/vscanas/"
              target="_blank"
              title="Linkedin"
              className="flex items-center justify-center w-10 h-10 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900"
            >
            ...
            <a
              rel="noopener noreferrer"
              href="https://github.com/VictorCanas"
              target="_blank"
              title="GitHub"
              className="flex items-center justify-center w-10 h-10 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900"
            >
            ...
            <a
              rel="noopener noreferrer"
              href="https://www.instagram.com/vscanas/"
              target="_blank"
              title="Instagram"
              className="flex items-center justify-center w-10 h-10 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900"
            >
            ...
            <a
              rel="noopener noreferrer"
              href="https://www.facebook.com/VictorCanasINT"
              target="_blank"
              title="Facebook"
              className="flex items-center justify-center w-10 h-10 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900"
            >
