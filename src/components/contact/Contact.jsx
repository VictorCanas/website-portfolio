...
export default function Contact() {
  return (
    <section id={"contact"}  className="py-6 dark:bg-gray-800 dark:text-gray-50">
      <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-50 pb-14">Contact</h2>
     	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
				<div className="py-6 md:py-0 md:px-6 sm:text-justify">
		    	<p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-400">Get in touch</p>
					...
					<div className="space-y-4">
						...
						<p className="flex items-center">
							...
							<span><a href="tel:7709277404">(770) 927-7404</a></span>
						</p>
						<p className="flex items-center">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
							...
							<span><a href = "mailto: ivictorcanas@gmail.com">ivictorcanas@gmail.com</a></span>
						</p>
					</div>
				</div>
